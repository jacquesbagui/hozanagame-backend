...
@section('content')
    <div style="opacity: 1;">
        <div class="theme--night">
            ...
            <div style="opacity: 1;">
                <div style="background-color:#a0e9ff" class="pr">
                    <div class="pf top left right" style="background-color:#a0e9ff;height:50vh"></div>
                    <div class="of--hidden">
                                            ...
                                            <div class="grid-container contained">
                                                <button class="db x" style="opacity: 1; transform: none;">
                                                    <div class="image size--1x1 contain">
                                                        <picture>
                                                            <source
                                                                srcset="https://res.cloudinary.com/ahoko/image/upload/v1652370809/Q1_myl4lp.png"
                                    ...
                                    <div class="product-hero__card push-up">
                                        <div class="product-hero__content"><h1 id="product-family-edition"
                                            ...
                                            <div class="rich-text line-break fs--16 fs--20--md fs--24--xl mb3">
                                                <div><p style="font-size: 18px">Hozana Quiz est un jeu de cartes
                                                        instructif basé sur des questions bibliques et vie chrétienne
                                                        jouable à 2 ou en groupe de manière linéaire.
                                                    </p>
                                                    <p style="font-size: 18px"><strong>Le jeu : </strong></p>
                                                    <p style="font-size: 18px">
                                                        Le joueur 1 engage la partie en piochant la première carte du
                                                        lot. Il lit le contenu de la carte au joueur 2 qui à son tour
                                                        doit répondre à la question posée. Après quoi , le joueur 2
                                                        prend la main et exécute le même cheminement.
                                                    </p>
                                                    <p style="font-size: 18px">
                                                    ...
                                                    <p style="font-size: 18px">
                                                        En cas de mauvaise réponse, le joueur fautif s'expose
                                                        automatiquement aux gages et pénalités à exécuter
                                                        obligatoirement.
                                                    </p>
                                                </div>
                                            </div>
                ...
                <div class="theme--night push-up">
                    <div class="theme--night pt5 pb5 pt9--lg pb9--lg of--hidden">
                        <div class="grid-container contained pl1 pr1 pl3--md pr3--md pl9--lg pr9--lg">
                            ...
                            <strong>Pour jouer à Hozana Quiz, il vous faut : </strong>
                                ...
                                <div
                                    ...
                                    <div>
                                        <div class="fs--homepage-faq rich-text line-break pb3 pl3--lg pb5--lg">
                                            <p>Devant chaque proposition de réponse est marquée une couleur. La bonne réponse est la proposition ayant la même couleur que la plume se trouvant au bas de la carte.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordeon--content">
                                ...
                                <div style="height:0;transition:height 400ms cubic-bezier(.12,.67,.53,1)"
                                     class="of--hidden" sizeHeight="medium">
                                    <div>
                                        <div class="fs--homepage-faq rich-text line-break pb3 pl3--lg pb5--lg">
                                            <p>
                                                Battez le lot de cartes.
                                                Le joueur 1 engage la partie en piochant la première carte du lot. Il lit le contenu de la carte au joueur 2 qui à son tour doit répondre à la question posée. Après quoi , le joueur 2 prend la main et exécute le même cheminement.
                                            </p>
                                            <p>
                                ...
                                <div class="of--hidden"
                                    ...
                                    <div>
                                        <div class="fs--homepage-faq rich-text line-break pb3 pl3--lg pb5--lg">
                                            <p>
                                                Battez le lot de cartes.
                                                L'équipe 1 engage la partie en piochant la première carte du lot. L'équipe 2 met en avant un joueur qui devra répondre au contenu de la carte lu par l'équipe 1.
                                            </p>
                                            <p>
                                                En cas de bonne réponse, l'équipe 2 prend la main à son tour et exécute le même cheminement.
                                                En cas de mauvaise réponse , le joueur fautif expose automatiquement son équipe aux gages ou pénalités.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div>
                                        <div class="fs--homepage-faq rich-text line-break pb3 pl3--lg pb5--lg">
                                            <p>
                                                ...
                                                Le joueur fautif pioche la première carte et exécute obligatoirement le gage après mélange du lot de cartes.
                                            </p>
                                            <p>
